...
import 'package:ehr/Dashboard/Travel%20Request/TravelCancelbyemploye.dart';
...
class Travelcancelstatuslist extends StatefulWidget {
  @override
  _TravelcancelstatuslistState createState() => _TravelcancelstatuslistState();
}

class _TravelcancelstatuslistState extends State<Travelcancelstatuslist> {
 ...
 Future<void> travelcancellist() async {
    ...
    final String restUrl ='${AppCongifP.apiurllink}/${AppCongifP.applicationName}/servicedata.aspx?callFor=TravelCancelList&EmpId=$empKid';
  ...
  void onButtonClicked(String travelRequestKid, String empId ){
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => Travelcancelbyemploye(  travelRequestKid: travelRequestKid,
          empId: empId,)),
    );
  }
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildRow("Travel ID", item.travelRequestID),
                        _buildRow("Start Date", item.startDate),
                        _buildRow("End Date", item.endDate),
                        _buildRow("Destination", item.destination),
                        _buildRow("Requested Date", item.requestDate),
                        _buildRow("Amount", item.estimatedCost.toString()),
