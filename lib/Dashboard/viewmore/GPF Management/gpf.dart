...
class WebViewExample extends StatefulWidget {
  final MobileMenu item;

  const WebViewExample({super.key, required this.item});

  @override
  // ignore: no_logic_in_create_state
  State<StatefulWidget> createState() => _WebViewExampleState(item: item);
}
...
class _WebViewExampleState extends State<WebViewExample> {
  ...
  _WebViewExampleState({required this.item});
  ...
  Widget build(BuildContext context) {
    String link = item.mobileMenuType.toString();
    String id = ViewData.emikid;

    link =
        'http://192.168.1.113/Mobile/Mobile/MobileAuthication.aspx?Empkid=$id&Type=$link&IsMobile=Y';

    // if(Gpfsavetitle.title == "GPF Request"){
    //          String  id =  ViewData.emikid;
    //       link = 'http://192.168.1.113/Mobile/Mobile/MobileAuthication.aspx?Empkid=$id&Type=GPFundRequest&IsMobile=Y';
    // }else if(Gpfsavetitle.title == "GPF Status"){
    //   String  id1 =  ViewData.emikid;
    //       link = 'http://192.168.1.113/Mobile/Mobile/MobileAuthication.aspx?Empkid=$id1&Type=GPFStatus&IsMobile=Y';

    // }else{
    //   String  id2 =  ViewData.emikid;
    //       link = 'http://192.168.1.113/Mobile/Mobile/MobileAuthication.aspx?Empkid=$id2&Type=GPFauth&IsMobile=Y';
