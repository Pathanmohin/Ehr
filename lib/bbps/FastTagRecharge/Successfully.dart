...
class SuccessfullyFastag extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _SuccessfullyFastag();
}

class _SuccessfullyFastag extends State<SuccessfullyFastag> {
