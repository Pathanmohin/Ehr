...
class SuccessfullyCredit extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _SuccessfullyCredit();
}

class _SuccessfullyCredit extends State<SuccessfullyCredit> {
