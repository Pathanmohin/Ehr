...
import 'package:ehr/bbps/Boardband/Boardbandbill.dart';
import 'package:ehr/bbps/Boardband/sucessbaordband.dart';
...
class BoardbandFatchBill extends StatefulWidget {
  final List<FastTagInfo> fastTagInfoList;

  BoardbandFatchBill({required this.fastTagInfoList});
  @override
  State<StatefulWidget> createState() => _BoardbandFatchBill();
}

class _BoardbandFatchBill extends State<BoardbandFatchBill> {
  @override
  void initState() {
    super.initState();
    dataFound();
  ...
  Future<bool> _onBackPressed() async {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => Boradbandbill()),
    );
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          if (responseData["Result"] == "Sucess") {
            ...
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => Successfullyboardband()));
          } else {
            Loader.hide();
