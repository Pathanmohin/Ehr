...
import 'package:ehr/bbps/ElectricityRecharge/Fetchbill.dart';
...
// Password Ency.
      ...
      String apiUrl = "${AppCongifP.apiurllinkBBPS}/rest/BBPSService/educationfetchbill";
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          if (responseData["Result"] == "Sucess") {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => const FatchBillElectricity()),
            );
          } else {
            Loader.hide();
