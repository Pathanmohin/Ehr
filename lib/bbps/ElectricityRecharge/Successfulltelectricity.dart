...
class SuccessfullyElectricity extends StatefulWidget {
  const SuccessfullyElectricity({super.key});

  @override
  State<StatefulWidget> createState() => _mobileSuccessfullyElectricity();
}

class _mobileSuccessfullyElectricity extends State<SuccessfullyElectricity> {
  ...
  Future<void> dataFound() async {
    ...
    setState(() {
      ...
      Resptype = prefs.getString("txnRespType") ?? '';

      resopneResponse = prefs.getString("responseReason") ?? '';

      RefnumberApprovel = prefs.getString("approvalRefNumber") ?? '';
    });
  }
